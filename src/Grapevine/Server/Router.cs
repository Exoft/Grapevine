...
namespace Grapevine.Server
{
    ...
    public interface IRouter
    {
        ...
        /// <returns>IRouter</returns>
        IRouter Register(Func<IHttpContext, IContainer, IHttpContext> func);
        ...
        /// <returns>IRouter</returns>
        IRouter Register(Func<IHttpContext, IContainer, IHttpContext> func, string pathInfo);
        ...
        /// <returns>IRouter</returns>
        IRouter Register(Func<IHttpContext, IContainer, IHttpContext> func, HttpMethod httpMethod);
        ...
        /// <param name="pathInfo"></param>
        /// <returns>IRouter</returns>
        IRouter Register(Func<IHttpContext, IContainer, IHttpContext> func, HttpMethod httpMethod, string pathInfo);
        ...
        /// </summary>
        /// <returns>IRouter</returns>
        IRouter ScanAssemblies(ContainerBuilder containerBuilder);
    ...
    public class Router : IRouter
    {
        ...
        public IRouter Import(Type type)
        {
            ...
            if (!type.Implements<IRouter>())
                throw new ArgumentException(
                    $"Cannot Import: {type.FullName} does not implement {typeof(IRouter).FullName}");
            if (!type.HasParameterlessConstructor())
                throw new ArgumentException($"Cannot Import: {type.FullName} does not have parameterless constructor");
        ...
        public IRouter Register(Func<IHttpContext, IContainer, IHttpContext> func)
        {
            AppendRoutingTable(new Route(func));
            return this;
        }

        public IRouter Register(Func<IHttpContext, IContainer, IHttpContext> func, string pathInfo)
        {
            AppendRoutingTable(new Route(func, pathInfo));
            return this;
        }

        public IRouter Register(Func<IHttpContext, IContainer, IHttpContext> func, HttpMethod httpMethod)
        {
            AppendRoutingTable(new Route(func, httpMethod));
            return this;
        }

        public IRouter Register(Func<IHttpContext, IContainer, IHttpContext> func, HttpMethod httpMethod, string pathInfo)
        {
        ...
        public IRouter ScanAssemblies(ContainerBuilder containerBuilder)
        {
            AppendRoutingTable(Scanner.Scan(containerBuilder));
        ...
        public void Route(object state)
        {
            ...
            catch (Exception e)
            {
                ...
                var status = context.Response.StatusCode == HttpStatusCode.Ok
        ...
        public void Route(IHttpContext context, IList<IRoute> routing)
        {
            ...
            try
            {
                ...
                foreach (var route in routing.Where(route => route.Enabled))
                {
                    ...
                    routeCounter++;
                    route.Invoke(context, _iocContainer);
        ...
        /// <summary>
        ///     Returns a new Router object configured by the provided Action and with the Scope property set to the parameter
        ///     supplied
        /// </summary>
